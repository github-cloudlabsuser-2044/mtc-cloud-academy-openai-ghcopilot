...
Este repositorio tiene el paso a paso para crear una aplicacion inteligente de tipo conversacional usando Azure Open AI, GitHub y sus herramientas.
...
En la guia estamos planteando un bot relacionado con Buceo, pero es recomendable que el escenario lo relaciones con la industria de tu escenario de negocio. 

Buscamos habilitar el siguiente escenario tecnico:
"aqui va la imagen"
